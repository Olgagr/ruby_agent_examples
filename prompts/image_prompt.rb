...
module Prompts
  module ImagePrompt
    # @param images [Array] an array of hashes with the following keys:
    #   - :name [String] the name of the image
    #   - :url [String] the url of the image
    #   - :alt [String] the alt text of the image
    #   - :base64 [String] the base64 encoded image
    #   - :description [String] the description of the image
    #   - :context [String] the context of the image
    # @return [String] the prompt
    def image_context_prompt(images:)
      <<~PROMPT
        Extract contextual information for images mentioned in a user-provided text, focusing on details that enhance understanding of each image, and return it as an array of JSON objects.

        <prompt_objective>
        To accurately identify and extract relevant contextual information for each image referenced in the given article,
        prioritizing details from surrounding text and broader article context that potentially aid in understanding the image.
    ...
    def image_visual_description_prompt
      <<~PROMPT
